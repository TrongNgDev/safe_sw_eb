...
#define CONFIG_WAMR_BUILD_RELEASE 1
#define CONFIG_WAMR_ENABLE_AOT 1
#define CONFIG_WAMR_ENABLE_INTERP 1
#define CONFIG_WAMR_INTERP_FAST 1
#define CONFIG_WAMR_INTERP_LOADER_NORMAL 1
#define CONFIG_WAMR_ENABLE_LIB_PTHREAD 1
#define CONFIG_WAMR_ENABLE_LIBC_BUILTIN 1
