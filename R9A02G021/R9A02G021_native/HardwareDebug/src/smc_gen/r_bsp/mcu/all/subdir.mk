...
src/smc_gen/r_bsp/mcu/all/%.o: ../src/smc_gen/r_bsp/mcu/all/%.s
	@echo 'Building file: $<'
	$(file > $@.in,--target=riscv32 -mabi=ilp32 -march=rv32imaczba_zbb_zbs -Oz -ffunction-sections -fdata-sections -flto -fdiagnostics-parseable-fixits -fno-strict-aliasing -Wunused -Wuninitialized -Wall -Wmissing-declarations -Wconversion -Wpointer-arith -Wshadow -Waggregate-return -g -x assembler-with-cpp -I"/home/tdn/safe-sw-eb/R9A02G021_native/src/smc_gen/r_pincfg" -I"/home/tdn/safe-sw-eb/R9A02G021_native/src/smc_gen" -I"/home/tdn/safe-sw-eb/R9A02G021_native/src/smc_gen/general" -I"/home/tdn/safe-sw-eb/R9A02G021_native/src/smc_gen/r_config" -I"/home/tdn/safe-sw-eb/R9A02G021_native/src/smc_gen/r_bsp" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c "$<" -o "$@")
	@clang @"$@.in"
src/smc_gen/r_bsp/mcu/all/%.o: ../src/smc_gen/r_bsp/mcu/all/%.c
	@echo 'Building file: $<'
	$(file > $@.in,--target=riscv32 -mabi=ilp32 -march=rv32imaczba_zbb_zbs -Oz -ffunction-sections -fdata-sections -flto -fdiagnostics-parseable-fixits -fno-strict-aliasing -Wunused -Wuninitialized -Wall -Wmissing-declarations -Wconversion -Wpointer-arith -Wshadow -Waggregate-return -g -std=gnu99 -I"/home/tdn/safe-sw-eb/R9A02G021_native/src/smc_gen/r_pincfg" -I"/home/tdn/safe-sw-eb/R9A02G021_native/src/smc_gen" -I"/home/tdn/safe-sw-eb/R9A02G021_native/src/smc_gen/general" -I"/home/tdn/safe-sw-eb/R9A02G021_native/src/smc_gen/r_config" -I"/home/tdn/safe-sw-eb/R9A02G021_native/src/smc_gen/r_bsp" -I"/home/tdn/safe-sw-eb/R9A02G021_native/src/RTT" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" "$<" -c -o "$@")
	@clang @"$@.in"
