...
/***********************************************************************************************************************
*  File Name    : r9a02g021_wamr_AOT_C.c
...
int main(void)
{
	os_printf("Starting WAMR-AOT mode, Wasm app compiled from C..\n");
    ...
    os_printf("Renesas_WAMR_AOT_C: Load   %d\n", cpu_cycle_load);
    os_printf("Renesas_WAMR_AOT_C: Run    %d\n", cpu_cycle_app);
    os_printf("Renesas_WAMR_AOT_C: Unload %d\n", cpu_cycle_unload);
    os_printf("Renesas_WAMR_AOT_C: Total  %d\n", cpu_cycle_load + cpu_cycle_app + cpu_cycle_unload);
#endif
