...
/***********************************************************************************************************************
*  File Name    : r9a02g021_wamr_interp_fast_C.c
...
int main(void)
{
	os_printf("Starting WAMR-Fast Interpreter mode, Wasm app compiled from C..\n");
    ...
    os_printf("Renesas_WAMR_FI_C: Load   %d\n", cpu_cycle_load);
    os_printf("Renesas_WAMR_FI_C: Run    %d\n", cpu_cycle_app);
    os_printf("Renesas_WAMR_FI_C: Unload %d\n", cpu_cycle_unload);
    os_printf("Renesas_WAMR_FI_C: Total  %d\n", cpu_cycle_load + cpu_cycle_app + cpu_cycle_unload);
#endif
