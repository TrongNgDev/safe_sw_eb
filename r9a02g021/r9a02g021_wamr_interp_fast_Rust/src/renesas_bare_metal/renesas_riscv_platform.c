...
os_time_get_boot_us(void)
{
	...
	os_printf("Warning: function os_time_get_boot_us() is not implemented\n");
#endif
    return 0;
}
...
{
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_time_thread_cputime_us() is not implemented\n");
#endif
...
os_self_thread(void){
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_self_thread() is not implemented\n");
#endif
    korp_tid id = 0;
    return id;
}
...
{
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_thread_get_stack_boundary() is not implemented\n");
#endif
    return NULL;
}
...
{
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_thread_jit_write_protect_np() is not implemented\n");
#endif
}
...
{
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_mutex_init() is not implemented\n");
#endif
    return 0;
}
...
{
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_mutex_destroy() is not implemented\n");
#endif
    return 0;
}
...
{
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_mutex_lock() is not implemented\n");
#endif
    return 0;
}
...
{
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_mutex_unlock() is not implemented\n");
#endif
    return 0;
}
...
{
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_thread_create() is not implemented\n");
#endif
	return 0;
}
...
{
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_thread_create_with_prio() is not implemented\n");
#endif
	return 0;
}
...
{
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_thread_join() is not implemented\n");
#endif
	return 0;
}
...
{
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_thread_detach() is not implemented\n");
#endif
	return 0;
}
...
{
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_thread_exit() is not implemented\n");
#endif
}
...
{
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_thread_env_init() is not implemented\n");
#endif
	return 0;
}
...
{
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_thread_env_destroy() is not implemented\n");
#endif
}
...
{
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_thread_env_inited() is not implemented\n");
#endif
	return false;
}
...
{
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_usleep() is not implemented\n");
#endif
	return 0;
}
...
{
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_recursive_mutex_init() is not implemented\n");
#endif
	return 0;
}
...
{
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_cond_init() is not implemented\n");
#endif
    return 0;
}
...
{
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_cond_destroy() is not implemented\n");
#endif
	return 0;
}
...
{
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_cond_wait() is not implemented\n");
#endif
	return 0;
}
...
{
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_cond_reltimedwait() is not implemented\n");
#endif
	return 0;
}
...
{
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_cond_signal() is not implemented\n");
#endif
	return 0;
}
...
{
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_cond_broadcast() is not implemented\n");
#endif
	return 0;
}
...
{
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_rwlock_init() is not implemented\n");
#endif
	return 0;
}
...
{
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_rwlock_rdlock() is not implemented\n");
#endif
	return 0;
}
...
{
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_rwlock_wrlock() is not implemented\n");
#endif
	return 0;
}
...
{
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_rwlock_unlock() is not implemented\n");
#endif
	return 0;
}
...
{
#if (BH_RENESAS_DEBUG ==1 )
	os_printf("Warning: function os_rwlock_destroy() is not implemented\n");
#endif
	return 0;
}
