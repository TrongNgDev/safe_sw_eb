...
/***********************************************************************************************************************
*  File Name    : r9a02g021_wamr_interp_fast_Rust.c
...
#if LOG_ENABLE == 1
    os_printf("WAMR: Run WAMR with Fast Interpreter\n");
#endif
...
int main(void)
{
	os_printf("Starting WAMR-Fast Interpreter mode, Wasm app compiled from Rust..\n");
    ...
    os_printf("Renesas_WAMR_FI_Rust: Load   %d\n", cpu_cycle_load);
    os_printf("Renesas_WAMR_FI_Rust: Run    %d\n", cpu_cycle_app);
    os_printf("Renesas_WAMR_FI_Rust: Unload %d\n", cpu_cycle_unload);
    os_printf("Renesas_WAMR_FI_Rust: Total  %d\n", cpu_cycle_load + cpu_cycle_app + cpu_cycle_unload);
#endif
