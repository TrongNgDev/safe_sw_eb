...
/***********************************************************************************************************************
*  File Name    : r9a02g021_wamr_AOT_Rust.c
...
#if LOG_ENABLE == 1
    os_printf("WAMR: Run WAMR with AOT\n");
#endif
...
int main(void)
{
	os_printf("Starting WAMR-AOT mode, Wasm app compiled from Rust..\n");
    ...
    os_printf("Renesas_WAMR_AOT_Rust: Load   %d\n", cpu_cycle_load);
    os_printf("Renesas_WAMR_AOT_Rust: Run    %d\n", cpu_cycle_app);
    os_printf("Renesas_WAMR_AOT_Rust: Unload %d\n", cpu_cycle_unload);
    os_printf("Renesas_WAMR_AOT_Rust: Total  %d\n", cpu_cycle_load + cpu_cycle_app + cpu_cycle_unload);
#endif
