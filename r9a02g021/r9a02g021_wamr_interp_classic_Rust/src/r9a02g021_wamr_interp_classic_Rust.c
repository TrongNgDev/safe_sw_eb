...
/***********************************************************************************************************************
*  File Name    : r9a02g021_wamr_interp_classic_Rust.c
...
int main(void)
{
	os_printf("Starting WAMR-Classic Interpreter mode, Wasm app compiled from Rust..\n");
    ...
    os_printf("Renesas_WAMR_CI_Rust: Load   %d\n", cpu_cycle_load);
    os_printf("Renesas_WAMR_CI_Rust: Run    %d\n", cpu_cycle_app);
    os_printf("Renesas_WAMR_CI_Rust: Unload %d\n", cpu_cycle_unload);
    os_printf("Renesas_WAMR_CI_Rust: Total  %d\n", cpu_cycle_load + cpu_cycle_app + cpu_cycle_unload);
#endif
